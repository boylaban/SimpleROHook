...
#define MAX_GROUNDSKILLTYPE 0x100

	DWORD m_M2ESkillColor[MAX_GROUNDSKILLTYPE];
...
public:
	CRoCodeBind() :
		m_hWnd(NULL),
		m_funcRagexe_PlayStream(NULL),
		m_CFileMgr__gfileMgr(NULL),
		m_functionRagexe_CFileMgr__GetPak(NULL),
		m_packetLenMap_table_index(0),
		m_packetqueue_head(0),
		m_pSFastFont(NULL),
...
public:
	...
	void InitWindowHandle(HWND hWnd)
	{
		m_hWnd = hWnd;
	};
